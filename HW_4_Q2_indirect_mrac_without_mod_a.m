% Q2-without modification-part a

a=5; 
% tf=200 dt=0.00001
% Case 1 where b is slightly small and plant stable without input
% unstable for a=-5 b=2 am=1 and bm=3 gamma=1 bhat(0)=1
% unstable for a=-5 b=2 am=1 and bm=3 gamma=1 bhat(0)=3
% stable for a=-5 b=2 am=1 and bm=3 gamma=1 bhat(0)=25

% Case 2 where b is slightly small and plant unstable without input
% unstable for a=5 b=2 am=1 and bm=3 gamma=1 bhat(0)=1
% unstable for a=5 b=2 am=1 and bm=3 gamma=1 bhat(0)=15 
% unstable for a=5 b=2 am=1 and bm=3 gamma=1 bhat(0)=25

% Case 3 where b is big (away from 0) and plant stable without input
% stable for a=-5 b=20 am=1 and bm=3 gamma=1 bhat(0)=1
% stable for a=-5 b=20 am=1 and bm=3 gamma=1 bhat(0)=15
% stable for a=-5 b=20 am=1 and bm=3 gamma=1 bhat(0)=25
